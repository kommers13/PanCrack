...
void TestTask11::lection_test(){
    ...
    string tree_n1 = "0110";
    Graph tree_n1_ans(5);
    tree_n1_ans.add_edge(0, 2, 0);
    tree_n1_ans.add_edge(1, 3, 0);
    tree_n1_ans.add_edge(1, 4, 0);
    tree_n1_ans.add_edge(0, 1, 0);
